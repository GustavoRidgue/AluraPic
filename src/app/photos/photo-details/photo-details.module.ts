import { CommentOwnerOnlyDirective } from './photo-comment/comment-owner-only.directive';
...
@NgModule({
    declarations: [PhotoDetailsComponent, PhotoCommentComponent, PhotoOwnerOnlyDirective, CommentOwnerOnlyDirective],
